...
#
#     PHX_SERVER=true bin/zero41_retrieve_github_issues start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :zero41_retrieve_github_issues, Zero41RetrieveGithubIssuesWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :zero41_retrieve_github_issues, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
