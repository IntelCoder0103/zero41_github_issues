defmodule Zero41RetrieveGithubIssuesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Zero41RetrieveGithubIssuesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Zero41RetrieveGithubIssuesWeb.Gettext, "errors", msg, opts)
    end
  end
